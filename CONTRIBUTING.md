# Contributing to grunt-testee

## Developing Locally

This section will walk you through setting up the [repository](https://github.com/bitovi/grunt-testee) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork grunt-testee, you can start by going to its [fork page](https://github.com/bitovi/grunt-testee/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/grunt-testee
```
